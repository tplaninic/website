...
(function() {
  ...
  function updatePhoneScreen() {
    ...
    if (wsSchedule) {
      ...
      setTimeout(function() {
        // All screens use font-size base of 14px to match the schedule screen size
        var base = 'font-family:Roboto,sans-serif;height:100%;display:flex;flex-direction:column;justify-content:center;padding:12px;gap:10px;';
        if (screen.type === 'swaps') {
          wsSchedule.innerHTML = '<div style="'+base+'"><div style="background:#E3F2FD;border-radius:14px;padding:18px;border-left:4px solid #1E88E5"><div style="font-size:12px;color:#666;margin-bottom:8px;text-transform:uppercase;letter-spacing:0.5px;font-weight:500">Swap Request</div><div style="font-weight:800;font-size:16px;color:#1a1a2e">Ana K. ⇄ Marko H.</div><div style="font-size:13px;color:#888;margin:6px 0">Mon Morning ↔ Tue Afternoon</div><div style="display:flex;gap:8px;margin-top:10px"><span style="flex:1;background:#4CAF50;color:#fff;padding:10px;border-radius:10px;text-align:center;font-size:13px;font-weight:700">✓ Approve</span><span style="flex:1;background:#f44336;color:#fff;padding:10px;border-radius:10px;text-align:center;font-size:13px;font-weight:700">✗ Deny</span></div></div><div style="background:#f5f5f5;border-radius:14px;padding:16px;opacity:0.6"><div style="font-size:12px;color:#999;text-transform:uppercase">Completed</div><div style="font-weight:700;font-size:14px;color:#444;margin-top:6px">Ivan P. ⇄ Luka M.</div><div style="color:#4CAF50;font-size:13px;margin-top:4px">✓ Approved</div></div></div>';
        } else if (screen.type === 'chat') {
          wsSchedule.innerHTML = '<div style="'+base+'gap:10px;"><div style="align-self:flex-start;background:#f0f0f0;padding:12px 16px;border-radius:18px 18px 18px 4px;font-size:14px;max-width:80%;color:#333">Can you cover my shift tomorrow?</div><div style="align-self:flex-end;background:#0D7C66;color:#fff;padding:12px 16px;border-radius:18px 18px 4px 18px;font-size:14px;max-width:80%">Sure, no problem!</div><div style="align-self:flex-start;background:#f0f0f0;padding:12px 16px;border-radius:18px 18px 18px 4px;font-size:14px;max-width:80%;color:#333">Thanks! 🙏</div><div style="align-self:flex-end;background:#0D7C66;color:#fff;padding:12px 16px;border-radius:18px 18px 4px 18px;font-size:14px;max-width:80%">I\'ll swap it in the app</div><div style="margin-top:auto;display:flex;align-items:center;background:#f5f5f5;border-radius:20px;padding:10px 16px"><span style="flex:1;color:#999;font-size:13px">Type a message...</span><span style="color:#0D7C66;font-size:18px">➤</span></div></div>';
        } else if (screen.type === 'analytics') {
          wsSchedule.innerHTML = '<div style="'+base+'text-align:center;"><div style="font-size:36px;font-weight:900;color:#1a1a2e">164.5h</div><div style="font-size:13px;color:#999;margin-bottom:16px">Total Hours This Month</div><div style="display:flex;align-items:flex-end;justify-content:center;gap:14px;height:100px"><div style="width:40px;background:linear-gradient(to top,#0D7C66,#4DB6AC);border-radius:6px 6px 0 0;height:50%"></div><div style="width:40px;background:linear-gradient(to top,#0D7C66,#4DB6AC);border-radius:6px 6px 0 0;height:70%"></div><div style="width:40px;background:linear-gradient(to top,#0D7C66,#4DB6AC);border-radius:6px 6px 0 0;height:60%"></div><div style="width:40px;background:linear-gradient(to top,#0D7C66,#4DB6AC);border-radius:6px 6px 0 0;height:85%"></div></div><div style="display:flex;justify-content:center;gap:14px;font-size:12px;color:#999;margin-top:6px"><span>W1</span><span>W2</span><span>W3</span><span>W4</span></div><div style="display:flex;gap:12px;justify-content:center;margin-top:16px"><div style="display:flex;align-items:center;gap:4px"><span style="width:10px;height:10px;border-radius:50%;background:#FF9800"></span><span style="font-size:12px;color:#666">Morning 45%</span></div><div style="display:flex;align-items:center;gap:4px"><span style="width:10px;height:10px;border-radius:50%;background:#1E88E5"></span><span style="font-size:12px;color:#666">Afternoon 35%</span></div></div></div>';
        } else if (screen.type === 'timeoff') {
          wsSchedule.innerHTML = '<div style="'+base+'"><div style="background:#fff;border-radius:14px;padding:18px;border-left:4px solid #4CAF50"><span style="background:#E8F5E9;color:#4CAF50;font-size:12px;font-weight:700;padding:4px 10px;border-radius:8px">Approved</span><div style="font-weight:800;font-size:16px;color:#1a1a2e;margin-top:8px">Vacation</div><div style="font-size:13px;color:#888;margin-top:4px">Mar 28 – Apr 2 · 5 working days</div></div><div style="background:#fff;border-radius:14px;padding:18px;border-left:4px solid #FF9800"><span style="background:#FFF3E0;color:#FF9800;font-size:12px;font-weight:700;padding:4px 10px;border-radius:8px">Pending</span><div style="font-weight:800;font-size:16px;color:#1a1a2e;margin-top:8px">Vacation</div><div style="font-size:13px;color:#888;margin-top:4px">May 12 – May 16 · 5 working days</div></div><div style="text-align:center;margin-top:12px;font-size:14px;color:#999"><span style="color:#0D7C66;font-weight:800;font-size:18px">12</span> days used of <span style="color:#0D7C66;font-weight:800;font-size:18px">20</span></div></div>';
        } else if (screen.type === 'export') {
          wsSchedule.innerHTML = '<div style="'+base+'"><div style="font-size:16px;font-weight:800;color:#1a1a2e;margin-bottom:8px">Export Report</div><div style="background:#fff;border-radius:14px;padding:18px;border:1px solid #eee;display:flex;align-items:center;gap:14px"><div style="width:44px;height:44px;background:#E53935;border-radius:10px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:14px;font-weight:800">PDF</div><div><div style="font-weight:700;font-size:14px;color:#333">PDF Report</div><div style="font-size:12px;color:#999;margin-top:2px">Full schedule + hours worked</div></div></div><div style="background:#fff;border-radius:14px;padding:18px;border:1px solid #eee;display:flex;align-items:center;gap:14px"><div style="width:44px;height:44px;background:#1B5E20;border-radius:10px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:13px;font-weight:800">XLS</div><div><div style="font-weight:700;font-size:14px;color:#333">Excel Export</div><div style="font-size:12px;color:#999;margin-top:2px">All workers data + analytics</div></div></div></div>';
        } else {
          // Default schedule
